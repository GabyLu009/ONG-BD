                  ...
                  <div class="card-header">
                    <div class="col-md-3 pull-right">
                      ...
                      <div class="col-md-3" style="margin-left:50%">
                            <a href="{{route('poblacion_create')}}" class="btn btn-block btn-primary">
                                    <i class="fa fa-fw fa-plus-circle"></i> Crear poblacion
                            </a>
                          </div>
                  </div>
                  <div class="card-body">
                      <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                          ...
                          <tbody>
                              ...
                              <td>{{$item->numerohabitantes}}</td>
                              <td>{{$item->nombre}}</td>
                              <td>{{$item->idpais}}</td>
                              <td>
                                <a href="/Poblacion/{{$item->idpoblacion}}/edit" class="btn btn-success">
                                    <i class="fa fa-pencil"></i></a>
                                <form action="{{route('poblacion_delete', ['Poblacion' => $item->idpoblacion])}}" method="POST">
